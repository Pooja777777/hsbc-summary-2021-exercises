...
public class ViewController {
	...
	public static void main(String[] args) {
		...
		do
		{
			System.out.println("1 for List operations\n2 for TreeSet operations");
			
			if(input1==1)
			{
				 empDao = FactoryPattern.getDaoInstance(1);
				 empService = FactoryPattern.getServiceInstance(empDao);
			}
			else
			{
				 empDao = FactoryPattern.getDaoInstance(2);
				 empService = FactoryPattern.getServiceInstance(empDao);
			}	
		}while(input1!=0);
		do
		{
			...
			case 1:
				...
				break;
			case 2:
				Collection<Employee> employee = empService.displayAll();
